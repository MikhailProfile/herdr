...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::AgentHistorySearch(_) => "agent_history.search",
        Method::AgentHistoryStatus(_) => "agent_history.status",
        Method::AgentHistoryRefresh(_) => "agent_history.refresh",
        Method::AgentHistoryMessages(_) => "agent_history.messages",
